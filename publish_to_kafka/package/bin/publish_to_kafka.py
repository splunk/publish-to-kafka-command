...
def get_account_api_key(session_key: str, account_name: str):
    cfm = conf_manager.ConfManager(
        session_key,
        ADDON_NAME,
        realm=f"__REST_CREDENTIAL__#{ADDON_NAME}#configs/conf-publish_to_kafka_account",
    )
    account_conf_file = cfm.get_conf("publish_to_kafka_account")
...
class Input(smi.Script):
    ...
    def get_scheme(self):
        scheme = smi.Scheme("publish_to_kafka")
        scheme.description = "publish_to_kafka input"
        ...
        for input_name, input_item in inputs.inputs.items():
            ...
            try:
                ...
                logger.error(
                    ...
                    f"publish_to_kafka: {e}. Traceback: "
